...
export const metadata: Metadata = {
  ...
  description:
    "صهيب الصالح: مستشار تقني أول ومهندس حلول من عمّان بخبرة تتجاوز عشرين عاماً في تكامل الأنظمة المؤسسية (Java، C#، SQL Server، Oracle)، وكلاء الذكاء الاصطناعي، والأتمتة. منصات عربية ثنائية اللغة حيّة وأنظمة إنتاجية لعملاء.",
  keywords,
