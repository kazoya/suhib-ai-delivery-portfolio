# نصوص قصيرة — LinkedIn · GitHub · مستقل / خمسات

## LinkedIn — العنوان (Headline)
...
Open to remote contracts or a solid engineering role on Arabic/bilingual products, or with teams adopting AI agents with real governance.

## GitHub — Profile README (kazoya)
```
Hi, I'm Suhib Asrawi (kazoya).

I build Arabic-first web platforms with Next.js and Laravel, and I run my
project portfolio through AI coding agents from a tracking platform I wrote
in dependency-free Node.js (CLI + HTTP + MCP).
...
## مستقل — العنوان والنبذة
**العنوان:** مهندس برمجيات — منصات ويب عربية (Next.js / Laravel) وأتمتة بوكلاء الذكاء الاصطناعي

**النبذة:**  
أبني مواقع ومنصات عربية ثنائية اللغة جاهزة للنشر: مواقع مصانع وشركات، متاجر ومنصات عرض للمستثمرين، لوحات تشغيل داخلية بأدوار وصلاحيات، وأدوات معرفة على وثائقك دون سحابة.  
أعمل بوكلاء برمجية تحت إشرافي، فتحصل على سرعة تنفيذ مع اختبارات وتقارير تقدّم مكتوبة لكل خطوة. آخر أعمالي: موقعا مصنعين ومتجر فاخر على Vercel خلال أسبوع، وأدوار مستخدمين في إنتاج منصة Laravel.  
خبرة مؤسسية سابقة في Java وC# وSQL (بنوك، حضور ودخول، طوابير).  
لا أعد بما لا أستطيع إثباته، وأسلّم مع الكود وسجل التغييرات.

**المهارات (10):** Next.js · React · TypeScript · Laravel · PHP · Node.js · PostgreSQL · Supabase · Vercel · Tailwind

## خمسات — خدمة نموذجية
**العنوان:** سأبني موقع شركة أو مصنع عربي ثنائي اللغة بـ Next.js وأنشره على Vercel  
**الوصف المختصر:** صفحة رئيسية + منتجات/خدمات + تواصل واتساب، RTL صحيح، وضع فاتح/داكن، SEO أساسي، نشر على رابط حي مع الكود الكامل. أمثلة منشورة عند الطلب.
