# العقل الهندسي — zaha-almajali / zaha-almajali

> ملف مُولَّد تلقائياً من `brain.json` + `journal/` — لا تعدّله يدوياً؛ استخدم `mb brain` / `mb log` أو أدوات MCP.

- **ID:** `zaha-almajali`  |  **الحالة:** مفتوح / Open  |  **التقدّم:** 0%  |  **الأولوية:** 3
- اكتُشف من claude+codex+cursor — C:\zahaalmajali  
  Discovered via claude+codex+cursor — C:\zahaalmajali
...
- package.json name=zaha-almajali version=0.1.0 | AGENTS.md present (600 chars excerpted). | git repository present — _Claude (generic)_ <sub>2026-09-10 · `b-d15afad6`</sub>
