# العقل الهندسي — gandalf / gandalf

> ملف مُولَّد تلقائياً من `brain.json` + `journal/` — لا تعدّله يدوياً؛ استخدم `mb brain` / `mb log` أو أدوات MCP.

- **ID:** `gandalf`  |  **الحالة:** مفتوح / Open  |  **التقدّم:** 0%  |  **الأولوية:** 3
- اكتُشف من cursor — C:\gandalf  
  Discovered via cursor — C:\gandalf
- **الوسوم:** discovered, cursor, python
...
- CLAUDE.md present (600 chars excerpted). — _Claude (generic)_ <sub>2026-09-10 · `b-54cafee9`</sub>
