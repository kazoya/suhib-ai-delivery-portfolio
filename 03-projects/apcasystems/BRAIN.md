# العقل الهندسي — apcasystems / apcasystems

> ملف مُولَّد تلقائياً من `brain.json` + `journal/` — لا تعدّله يدوياً؛ استخدم `mb brain` / `mb log` أو أدوات MCP.

- **ID:** `apcasystems`  |  **الحالة:** مفتوح / Open  |  **التقدّم:** 0%  |  **الأولوية:** 3
- اكتُشف من cursor — C:\apcasystems  
  Discovered via cursor — C:\apcasystems
...
- CLAUDE.md present (600 chars excerpted). — _Claude (generic)_ <sub>2026-09-10 · `b-217ec239`</sub>
