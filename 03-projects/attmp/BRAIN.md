# العقل الهندسي — attmp / attmp

> ملف مُولَّد تلقائياً من `brain.json` + `journal/` — لا تعدّله يدوياً؛ استخدم `mb brain` / `mb log` أو أدوات MCP.

- **ID:** `attmp`  |  **الحالة:** مفتوح / Open  |  **التقدّم:** 0%  |  **الأولوية:** 3
- اكتُشف من codex+cursor — C:\attmp  
  Discovered via codex+cursor — C:\attmp
- **الوسوم:** discovered, codex, cursor
...
- CLAUDE.md present (600 chars excerpted). | git repository present — _Claude (generic)_ <sub>2026-09-10 · `b-ab509c64`</sub>
