# العقل الهندسي — apccasystems.com / apccasystems.com

> ملف مُولَّد تلقائياً من `brain.json` + `journal/` — لا تعدّله يدوياً؛ استخدم `mb brain` / `mb log` أو أدوات MCP.

- **ID:** `apccasystemscom`  |  **الحالة:** مفتوح / Open  |  **التقدّم:** 0%  |  **الأولوية:** 3
- اكتُشف من cursor — C:\apccasystems.com  
  Discovered via cursor — C:\apccasystems.com
- **الوسوم:** discovered, cursor, web
...
- CLAUDE.md present (600 chars excerpted). — _Claude (generic)_ <sub>2026-09-10 · `b-3639ea6b`</sub>
