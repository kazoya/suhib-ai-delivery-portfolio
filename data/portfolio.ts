...
export const capabilities: { name: string; evidence: string; level: Confidence }[] = [
  ...
  { name: "أمن تطبيقات الويب عملياً (Burp Suite Pro)", evidence: "PortSwigger Academy 273/273 مختبراً · مستوى Expert · جاهز لامتحان BSCP", level: "عالي" },
  { name: "صيانة أنظمة التشغيل واستعادة الملفات المحذوفة", evidence: "HDD / USB / microSD / أندرويد بممارسة غير تدميرية (السيرة + السجل الهندسي)", level: "عالي" },
  { name: "هندسة عكسية لتطبيقات Android (APK)", evidence: "تقارير فك حزمة وتتبع اتصالات وتوثيق أسرار مضمّنة", level: "متوسط" },
